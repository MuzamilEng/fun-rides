...
const LatestEvent = () => {
  ...
  return (
    <main className="bg-[#f8d311] px-[2vw] pt-[5vw] pb-[2vw]">
      <h1 className="text-white font-bold text-[6vw] lg:text-[5vw] text-center mb-[5vw] lg:mb-[2vw]">
        Latest Event
      </h1>
        ...
        {servicesData?.map((service, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-black opacity-0 hover:opacity-70 transition-opacity duration-300 flex items-center justify-center rounded-md">
              <button
                className={`${btnColors[index]} text-white lg:font-medium p-[4vw] lg:p-[1vw] lg:w-[10vw] lg:h-[4vw] rounded-md transition-all duration-300 hover:scale-105 absolute bottom-[1vw]`}
              >
                {service.btn}
              </button>
            </div>
